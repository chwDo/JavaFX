 ...
 */
public class TiankongController implements Initializable {
    ...
    int i=0;
    String s[]=MaincontrolController.tk;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        l_index.setText((i+1)+"");
        l_context.setText(FXMLDocumentController.timu.tk[i].getTitle_Contents());
    ...
    private void next_clicked(MouseEvent event) {
          ...
          if(i==9)  next_question.setDisable(true);
          else{
